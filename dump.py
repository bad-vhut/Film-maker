...
logo = f"""\033[38;5;46m
     ...
     ██      ██ ███████ ███████  FILE MAKING 😈🤟
----------------------------------------------
\033[1;93m[√] \033[1;97mYOUR NAME  : {sh}
\033[1;93m[√] AUTHOR     : Bad-Vhut 😈
\033[1;93m[√] GITHUB     : bad-vhut 
\033[1;93m[√] TOOL TYPE  : FILE MAKING
\033[1;93m[√] TOOL VIRSION : 5.1
----------------------------------------------
...
class login():
	...
	def login_WALA(self):
		...
		print(' \u001b[36m[\u001b[36mA\033[1;37m] \033[1;93m WITH ID PASS   • WORKING ')
		print(' \u001b[36m[\u001b[36mB\033[1;37m] \u001b[36m WITH COOKIES   • NOT WORKING ')
		print(' \u001b[36m[\u001b[36mC\033[1;37m] \u001b[36m TO BACK ')
		linex()
...
def main_menu():
	...
	print(' \u001b[36m[A] CREATE FILE SIMPLE ')
	print(' \u001b[36m[B] CREATE FILE UNLIMITED ')
	print(' \u001b[36m[C] REMOVE DUPLICATE IDz ')
	print(' \u001b[36m[D] REPORT GLITCH ')
	print(' \u001b[36m[E] LOGOUT')
	linex()
